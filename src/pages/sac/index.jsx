  ...
  const [items, setItems] = useState([
    {
      ...
      content: "Um banco digital é uma instituição financeira que oferece serviços bancários online, sem a necessidade de agências físicas. Ele permite que os clientes acessem suas contas, façam transações e controlem suas finanças por meio de aplicativos móveis e sites.",
    },
    {
      title: "Como posso garantir a segurança da minha conta bancária online?",
      content: "Para garantir a segurança da sua conta no Tiradentes Finance, é crucial manter suas credenciais de login confidenciais e atualizadas regularmente. Além disso, utilize as medidas de segurança adicionais oferecidas por nós, como autenticação de dois fatores e alertas de atividade suspeita para monitorar sua conta.",
    },
    {
      title: "Quais são os limites diários para transferências e pagamentos online?",
