...
export default function BaseSite() {
  ...
  return (
    <div className="fundoSite">
      ...
      >
        <img src={hamburger} alt='' width={30} height={30} style={{ filter: 'invert(100%)', fill: 'white' }} />
      </button>

      <div className={`sideBarFundo col-auto min-vh-100 flex-column justify-between sideBar ${sidebarVisible ? 'show' : ''}`}>
        <div className="text-decoration-none text-white d-flex align-items-center">
          <img src={logo} alt="Logo" className="img-fluid logoNav" style={{ maxWidth: "100px" }} />
        </div>
